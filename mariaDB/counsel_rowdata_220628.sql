...
-- 테이블 데이터 counsel.counsel_info:~14 rows (대략적) 내보내기
...
INSERT IGNORE INTO `counsel_info` (`COUNSEL_BNO`, `COUNSEL_TITLE`, `COUNSEL_CONTENT`, `COUNSEL_WRITER`, `COUNSEL_USERID`, `COUNSEL_REGDATE`, `COUNSEL_REPLYCNT`, `COUNSEL_UPDATEWRITER`, `COUNSEL_UPDATEDATE`) VALUES
	(1018, '게시글 작성 커몬', '게시글 작성 커몬', '테스트', 'wang', '2022-06-21 16:17:59', 1, '테스트', '2022-06-24 17:42:15'),
	(1022, '비속어 테스트 *****', '***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ********** ********** ********** ********** ***** ***** ***** ***** ***** ***** ********** ***** ***** ***** *****', '욕쟁이', 'wang', '2022-06-21 16:20:42', 1, '욕쟁이', '2022-06-24 17:42:15'),
	(1023, '*****', '*****', '유효성', 'wang', '2022-06-21 16:22:10', 1, '유효성', '2022-06-24 17:42:15'),
	(1025, '***** 바이 *****', '***** 바이 ***** ***** 바이 ***** ***** 바이 ***** ***** 바이 *****', '크리젠', 'wang', '2022-06-21 17:52:30', 2, '크리젠', '2022-06-24 17:42:15'),
	(1030, '감감감', '감감감', '감감감', 'wang', '2022-06-24 13:16:34', 1, '감감감', '2022-06-24 17:42:15'),
	(1031, '게시글 작성 커몬', '123', '44', 'song', '2022-06-24 15:29:55', 0, '44', '2022-06-24 17:42:15'),
	(1032, '테스트1', '테스트', '테스트', 'song', '2022-06-27 09:50:24', 0, '테스트555', '2022-06-27 09:54:13'),
	(1033, '*****', '*************************', '*****', 'song', '2022-06-27 09:59:24', 0, '*****', '2022-06-27 10:09:00'),
	(1034, '123', '123', '123', 'song', '2022-06-27 10:04:15', 0, '123', '2022-06-27 10:04:15'),
	(1035, '*****', '**********', '*****', 'song', '2022-06-27 10:07:41', 0, '*****', '2022-06-27 10:09:00'),
	(1036, '*****', '**********', '*****', 'song', '2022-06-27 10:07:41', 0, '*****', '2022-06-27 10:09:00'),
	(1037, '테스트입니당', '테스트입니당', '*****한 *****이', 'song', '2022-06-27 10:11:07', 0, '김테스', '2022-06-27 10:15:22'),
	(1038, 'test', 'test', 'test', 'gogo', '2022-06-27 16:43:43', 0, 'test', '2022-06-27 16:43:43'),
	(1039, '가나다라', '가나다라', '가나다라', 'gogo', '2022-06-27 16:43:52', 6, '가나다라', '2022-06-27 16:43:52'),
	(1040, '게시글 작성 커몬2', '게시글 작성 커몬2', '게시글 작성 커몬', 'ww', '2022-06-27 18:01:11', 0, '게시글', '2022-06-27 18:05:00');
...
CREATE TABLE IF NOT EXISTS `counsel_reply` (
  ...
  CONSTRAINT `FK_USER_INFO_REPLY_USERID` FOREIGN KEY (`COUNSEL_REPLY_USERID`) REFERENCES `user_info` (`USER_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='덧글 테이블';

-- 테이블 데이터 counsel.counsel_reply:~9 rows (대략적) 내보내기
/*!40000 ALTER TABLE `counsel_reply` DISABLE KEYS */;
INSERT IGNORE INTO `counsel_reply` (`COUNSEL_REPLY_RNO`, `COUNSEL_REPLY_CONTENT`, `COUNSEL_REPLY_WRITER`, `COUNSEL_REPLY_REGDATE`, `COUNSEL_REPLY_BNO`, `COUNSEL_REPLY_USERID`) VALUES
	(1018, '게시글 작성 커몬', '테스트', '2022-06-21 16:18:56', 1018, 'song'),
	(1022, '***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ********** ********** ********** ********** ***** ***** ***** ***** ***** ***** ********** ***** ***** *****', '욕쟁이', '2022-06-21 16:20:48', 1022, 'song'),
	(1027, '******************************', '***** 김*****', '2022-06-21 16:23:15', 1023, 'song'),
	(1028, '***** 바이 ***** ***** 바이 ***** ***** 바이 ***** ***** 바이 *****', '김둥둥', '2022-06-21 17:52:41', 1025, 'song'),
	(1029, '***** 바이 ***** ***** 바이 ***** ***** 바이 ***** ***** 바이 *****', '김둥둥', '2022-06-21 17:52:49', 1025, 'song'),
	(1031, 'asd', 'asd', '2022-06-24 13:47:50', 1030, 'song'),
	(1033, '간다2', '간다2', '2022-06-27 17:01:11', 1039, 'song'),
	(1034, '간다3', '간다3', '2022-06-27 17:30:02', 1039, 'song'),
	(1036, 'adf', '', '2022-06-27 17:45:24', 1039, 'song'),
	(1037, '123', '123', '2022-06-27 17:46:45', 1039, 'song'),
	(1038, '123', '123', '2022-06-27 17:46:50', 1039, 'song'),
	(1039, '123', '123', '2022-06-27 17:50:35', 1039, 'song'),
	(1040, '111 234', '', '2022-06-27 17:58:55', 1039, 'ww');
...
-- 테이블 데이터 counsel.user_auth:~5 rows (대략적) 내보내기
...
-- 테이블 데이터 counsel.user_info:~4 rows (대략적) 내보내기
...
INSERT IGNORE INTO `user_info` (`USER_ID`, `USER_PW`, `USER_NAME`, `USER_REGDATE`, `USER_ENABLED`, `USER_AUTHS`, `USER_FAILEDCNT`) VALUES
	('gogo', '1e9ec075a3610627987394ca379fe6a134648a77a2ed0241bb38b53c50b664515e517b523a8a20d8', '고고고', '2022-06-27 16:41:51', '1', NULL, 0),
	...
	('wang', 'afb8dcdda2061fde9a50e317553ccf8c36d86e66feb3bffed9856327cba26a8969dd04b48f2de12f', '왕방구', '2022-06-23 15:18:58', '1', NULL, 0),
	('ww', 'f134a019ab09fc675aec1ac9714fd8c5f328e1f312341ed1aeb2deb631ba45c6b4f9b0a0dada2277', '덥덥', '2022-06-27 17:57:53', '1', NULL, 0);
